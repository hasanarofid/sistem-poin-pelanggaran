        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ request()->routeIs('admin.*') ? route('admin.siswa.update', $siswa->id) : route('guru.siswa.update', $siswa->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="hp_orang_tua" name="hp_orang_tua"
                                            value="{{ old('hp_orang_tua', $siswa->hp_orang_tua) }}">
                                        @error('hp_orang_tua')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            name="status">
                                            <option value="1"
                                                {{ old('status', $siswa->status) == 1 ? 'selected' : '' }}>Aktif</option>
                                            <option value="0"
                                                {{ old('status', $siswa->status) == 0 ? 'selected' : '' }}>Tidak Aktif
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            var existingKelasId = "{{ $siswa->kelas_id ?? '' }}";

            // Jika ada kelas yang dipilih dari URL parameter
            ...
            // Jika ada kelas yang sudah ada dari data siswa (untuk form edit)
            else if (existingKelasId && existingKelasId !== '') {
                // Kelas sudah dimuat di HTML, hanya perlu trigger change

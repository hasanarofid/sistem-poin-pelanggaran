...
@section('breadcrumbs')
<li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">list Master Tupoksi</a></li>
<style>
  #data-table_info {
    font-size: 12px;
  }
          ...
          <div class="row">
            ...
            <div class="col-6 d-flex justify-content-end">
              ...
              <div class="btn-group" role="group" aria-label="Basic example">
                <a class="btn btn-sm bg-primary text-white " href="{{  route('mastertupoksi.add')  }}"><i class="fas fa-plus" aria-hidden="true"></i> Add </a>

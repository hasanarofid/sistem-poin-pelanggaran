...
@section('titelcard', 'Dashboard Guru')
@section('content')
    <div class="content-wrapper" style="margin: 0 !important; padding: 0 !important; width: 100% !important;">
        <div class="container-xxl flex-grow-1 container-p-y" style="padding: 30px !important; width: 100% !important; max-width: none !important; margin: 0 !important;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="mb-0" style="font-size: 28px; font-weight: 700; color: #1f2937;">Dashboard Guru - {{ $kelas->subkelas ?? 'Kelas' }}</h1>
            </div>
                ...
                <div class="col-xl-3 col-md-6 col-12 mb-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <small class="text-muted">Siswa di kelas {{ $kelas->subkelas ?? 'N/A' }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-12 mb-4">

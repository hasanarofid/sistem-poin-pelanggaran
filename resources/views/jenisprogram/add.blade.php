...
@section('title', 'Add  Jenis Program')
@section('titelcard', 'Add  Jenis Program')
                  ...
                  <div class="card-header pb-0 p-3">
                      <div class="row">
                          <div class="col-6 d-flex align-items-center">
                              <h6 class="mb-0">Add  Jenis Program</h6>
                          </div>
...
@endif
                     ...
                     <form class="row g-3" action="{{ route('jenisprogram.store') }}"
                        method="POST"
